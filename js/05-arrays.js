...
document.writeln("<h2>Mostrar el array de canciones</h2>");
...
document.writeln(
  '<h2 class="mt-3">Agregar un elemento al inicio del array</h2>'
);
...
document.writeln(
  '<h2 class="mt-3">Agregar un elemento al final del array</h2>'
);
...
document.writeln(
  `<h2 class="mt-3">Agregar un elemento en el medio del array - cantidad de elementos ${canciones.length}</h2>`
);
document.writeln('<ul class="list-group">');
for (let i = 0; i < canciones.length; i++) {
  document.writeln(`<li class="list-group-item">${canciones[i]}</li>`);
...
canciones.shift();
document.writeln(
  `<h2 class="mt-3">Borrar un elemento del inicio del array - cantidad de elementos ${canciones.length}</h2>`
);
...
//borrar al ultimo del array
canciones.pop()
document.writeln(
  `<h2 class="mt-3">Borrar un elemento del final del array - cantidad de elementos ${canciones.length}</h2>`
);
...
document.writeln(
  `<h2 class="mt-3">Borrar un elemento del medio del array - cantidad de elementos ${canciones.length}</h2>`
);
...
document.writeln(
  `<h2 class="mt-3">Modificar un elemento del array - cantidad de elementos ${canciones.length}</h2>`
);
